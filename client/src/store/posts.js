...
const posts = {
  ...
  actions: {
    ...
    //         new URLSearchParams({ _page: state.page, _limit: state.limit }),
    //       {
    //         method: "GET",
    //         headers: {
    //           "Content-Type": "application/json",
    ...
    //   fetch(
    //     "https://jsonplaceholder.typicode.com/posts?" + new URLSearchParams({ _page: state.page, _limit: state.limit }),
    //     {
    //       method: "GET",
    //       headers: {
    //         "Content-Type": "application/json",
