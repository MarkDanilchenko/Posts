      ...
      <div class="container-fluid">
        ...
        <div id="navbarContent" class="collapse navbar-collapse">
          <ul class="navbar-nav me-auto">
            <li class="nav-item">
              <router-link class="me-3 nav-link" to="/posts" :class="{ 'nav-link-active': $route.path === '/posts' }"
                >Posts</router-link
              >
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/about" :class="{ 'nav-link-active': $route.path === '/about' }"
                >About</router-link
              >
            </li>
          </ul>
...
<script>
import colorModeSwitcherInit from "@/mixins/colorModeSwitcherInit";
