        ...
        <div class="container-fluid">
            <router-link v-if="$route.path == '/'" to="/" class="navbar-brand nav-link-active-logo me-3 p-0">
                <img src="@/assets/IMG/Vue3_logo.png" width="30" height="30" class="d-inline-block align-text-top"
                    alt="Vue3 logo" title="Vue3 logo">
            </router-link>
            <router-link v-if="$route.path !== '/'" to="/" class="navbar-brand me-3 p-0">
                <img src="@/assets/IMG/Vue3_logo.png" width="30" height="30" class="d-inline-block align-text-top"
                    alt="Vue3 logo" title="Vue3 logo">
            </router-link>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item dropdown">
                        <router-link v-if="$route.path == '/posts' || $route.path == '/posts-vuex'" to="#"
                            class="me-3 nav-link nav-link-active dropdown-toggle" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">Posts info</router-link>
                        <router-link v-if="$route.path !== '/posts' && $route.path !== '/posts-vuex'" to="#"
                            class="me-3 nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">Posts info</router-link>
                    ...
                    <li class="nav-item">
                        <router-link v-if="$route.path == '/about'" to="/about"
                            class="nav-link nav-link-active">About</router-link>
                        <router-link v-if="$route.path !== '/about'" to="/about" class="nav-link">About</router-link>
                    </li>
                </ul>
                <span class="navbar-text text-small me-3 d-lg-inline-block d-none">
                    This is a Vue3 tutorial project =&#41;
                </span>
                <!-- colorMode switcher -->
                <!-- colorMode switcher -->
                <!-- colorMode switcher -->
